      ...
      <div className="container flex h-20 items-center justify-between px-4 md:px-6">
        ...
        <Link href="/command-center">
          <div className="flex items-center gap-3 hover:opacity-80 transition-opacity cursor-pointer">
            <div className="h-10 w-10 md:h-12 md:w-12 bg-[url('https://files.manuscdn.com/user_upload_by_module/session_file/91847194/gyGbyIhzvPIKVJwA.jpg')] bg-cover bg-center rounded-md border-2 border-gold/50 shadow-lg shadow-gold/20" />
              ...
              <SheetHeader>
                <SheetTitle className="text-left">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="h-10 w-10 bg-[url('https://files.manuscdn.com/user_upload_by_module/session_file/91847194/gyGbyIhzvPIKVJwA.jpg')] bg-cover bg-center rounded-md border-2 border-gold/50" />
                    <div className="flex flex-col">
