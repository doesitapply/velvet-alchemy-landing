      ...
      <div className="container flex h-16 items-center justify-between">
        ...
        <Link href="/command-center">
          <a className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            <div className="h-8 w-8 bg-[url('https://files.manuscdn.com/user_upload_by_module/session_file/91847194/gyGbyIhzvPIKVJwA.jpg')] bg-cover bg-center rounded-sm border border-gold/50" />
